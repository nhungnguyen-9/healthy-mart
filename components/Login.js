    ...
    return (
        <View style={tw`bg-white p-5 flex-1 w-full`}>
            <View style={tw`flex justify-center items-center mt-5`}>
                <Image style={{ width: "200px", height: "200px" }} source={require("/public/login.png")} />
            </View>
            <Text style={tw`text-xl my-5 text-center font-bold`}>Login your account</Text>
            <View style={tw``}>
            ...
            <View style={tw`flex flex-row gap-2 justify-center items-center`}>
                ...
                <TouchableOpacity style={tw``} onPress={() => props.navigation.navigate("Register")}>
