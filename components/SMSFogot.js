        ...
        <View style={tw`flex-1 bg-white p-5`}>
            <View style={tw` w-full`}>
                <View style={tw`flex justify-center items-center mt-5`}>
                    <Image style={{ width: "200px", height: "200px" }} source={require("/public/sms.png")} />
                </View>
                <View style={tw``}>
                ...
                <View style={tw`mt-5 flex gap-3 flex-row`}>
                    <View style={tw`bg-[#f4f7fe] flex-1 rounded-xl `}>
                        <TextInput maxLength={1} keyboardType="numeric" style={tw`py-5 flex justify-center items-center text-xl pl-[38px]`} />
                    </View>
                    <View style={tw`bg-[#f4f7fe] flex-1 rounded-xl `}>
                        <TextInput maxLength={1} keyboardType="numeric" style={tw`py-5 flex justify-center items-center text-xl pl-[38px]`} />
                    </View>{" "}
