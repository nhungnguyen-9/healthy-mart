    ...
    return (
        <View style={tw`bg-white p-5 flex-1 w-full`}>
            <View style={tw`flex justify-center items-center mt-5`}>
                <Image style={{ width: "200px", height: "200px" }} source={require("/public/register.png")} />
            </View>
            <Text style={tw`text-xl my-5 text-center font-bold`}>Create your account</Text>
            <View style={tw``}>
                <TextInput value={text} onChangeText={onChangeText} mode="outlined" outlineColor="#ccc" activeOutlineColor="#38b000" label="Email address" />
            ...
            <TouchableOpacity style={tw`py-2 bg-[#38b000] rounded-md my-5  `}>
                <Text style={tw`text-white text-center text-lg`}>Create an account</Text>
            </TouchableOpacity>
            ...
            <View style={tw`flex flex-row justify-center gap-3 items-center my-5`}>
                <TouchableOpacity>
                    <View style={tw`border-[1px] border-[#ccc] p-2 w-[50px] h-[50px]  rounded-xl flex justify-center items-center`}>
                        <Ionicons name="logo-google" color={"#fbbc03"} size={25}></Ionicons>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity>
                    <View style={tw`border-[1px] border-[#ccc] p-2 w-[50px] h-[50px]  rounded-xl flex justify-center items-center`}>
                        <Ionicons name="logo-facebook" color={"#1977f3"} size={25}></Ionicons>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity>
                    <View style={tw`border-[1px] border-[#ccc] p-2 w-[50px] h-[50px]  rounded-xl flex justify-center items-center`}>
            ...
            <View style={tw`flex flex-row gap-2 justify-center items-center`}>
                ...
                <TouchableOpacity style={tw``} onPress={() => props.navigation.goBack()}>
