  ...
  return (
    <View style={tw`bg-white p-5 flex-1 flex justify-center items-center`}>
      <View style={tw`w-full`}>
        <TouchableOpacity
          style={tw`flex justify-center items-center mt-5`}
          onPress={() => props.navigation.navigate("Home")}
        >
          <Image
            style={{ width: "500px", height: "300px" }}
            source={require("../public/login-and-regis.jpg")}
          />
        </TouchableOpacity>
        ...
        <View style={tw`flex flex-col gap-5 my-5`}>
          <TouchableOpacity style={tw`w-full`}>
            <View
              style={tw`bg-[#ea4235] p-2  rounded-xl flex flex-row gap-2 justify-center items-center`}
            >
          ...
          <TouchableOpacity>
            <View
              style={tw`bg-[#1977f3] p-2  rounded-xl flex flex-row gap-2 justify-center items-center`}
            >
              <Ionicons
                name="logo-facebook"
                color={"#fff"}
          ...
          <TouchableOpacity>
            <View
              style={tw`bg-[#000000]  p-2  rounded-xl flex flex-row gap-2 justify-center items-center`}
            >
        ...
        <View style={tw`flex flex-row gap-2 justify-center items-center`}>
          ...
          <TouchableOpacity style={tw``}>
            <Text
              style={tw`text-[#38b000] border-b-[1px] border-[#38b000]`}
